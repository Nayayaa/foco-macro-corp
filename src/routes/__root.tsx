...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Brasil em Foco — Anatomia de Três Choques" },
      { name: "description", content: "Dashboard macroeconômico e corporativo do Brasil 2014–2024." },
      { name: "author", content: "Brasil em Foco" },
      { property: "og:title", content: "Brasil em Foco — Anatomia de Três Choques" },
      { property: "og:description", content: "Dashboard macroeconômico e corporativo do Brasil 2014–2024." },
